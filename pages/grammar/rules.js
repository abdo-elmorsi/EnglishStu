...
export default function Test_yourself() {
    return (
        <>
            <h1 className="mb-4">20 Grammar Rules</h1>

            <p>
                Here are 20 simple rules and tips to help you avoid mistakes in
                English grammar. For more comprehensive rules please look under
                the appropriate topic (part of speech etc) on our{" "}
            ...
            <p>
                <strong>
                    ...
                    period/full stop, a question mark or an exclamation mark.
                </strong>
            </p>
            <ul>
                <li>
            ...
            <p>
                <strong>
                    ...
                    Subject-Verb-Object. (Negative and question sentences may
            ...
            <p>
                <strong>
                    3. Every sentence must have a subject and a verb. An object
                    is optional. Note that an imperative sentence may have a
                    verb only, but the subject is understood.
                </strong>
            </p>
            <ul>
                <li>
                ...
                <li>
                    <em>
                        Stop! (i.e. <span className="text-info">You stop</span>
                        !)
                    </em>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <em>
                        John <span className="text-info">works</span> in London.
                    </em>
                </li>
                <li>
                    <em>
                        That monk <span className="text-info">eats</span> once a
                        day.
                    </em>
                </li>
                <li>
                    <em>
                        John and Mary <span className="text-info">work</span> in
                        London.
                    </em>
                </li>
                <li>
                    <em>
                        Most people <span className="text-info">eat</span> three
                        meals a day.
                    </em>
                </li>
            </ul>
            ...
            <p>
                <strong>
                    5. When two singular subjects are connected by <em>or</em>,
                    use a singular verb. The same is true for <em>either/or</em>{" "}
                    and <em>neither/nor</em>.
                </strong>
            </p>
            <ul>
                <li>
            ...
            <ul>
                ...
                <li>
                    <em>
                        She married a{" "}
                        <span className="text-info">handsome Italian</span> man.
                    </em>
                </li>
                <li>
                    <em>
                        (Her husband is <span className="text-info">rich</span>
                        .)
                    </em>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <em>
                        I saw a <span className="text-info">nice French</span>{" "}
                        table.
                    </em>
                </li>
                <li>
            ...
            <p>
                <strong>
                    ...
                    (e.g. committee, company, board of directors) as singular OR
                    plural. In BrE a collective noun is usually treated as
                    plural, needing a plural verb and pronoun. In AmE a
                    collective noun is often treated as singular, needing a
            ...
            <ul>
                ...
                <li>
                    <em>
                        The BBC <span className="text-info">have</span> changed{" "}
                        <span className="text-info">their</span> logo.
                        (typically BrE)
                    </em>
                </li>
                <li>
                    <em>
                        My family <span className="text-info">likes</span> going
                        to the zoo. (typically AmE)
                    </em>
                </li>
                <li>
                    <em>
                        CNN <span className="text-info">has</span> changed{" "}
                        <span className="text-info">its</span> logo. (typically
                        AmE)
                    </em>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <em>
                        The dog has hurt <span className="text-info">its</span>{" "}
                        leg.
                    </em>
                </li>
                <li>
            ...
            <ul>
                <li>
                    <em>
                        Here is <span className="text-info">your</span> coffee.
                    </em>
                </li>
                <li>
                    <em>
                        <span className="text-info">You're</span> looking good.
                    </em>
                </li>
            </ul>
            ...
            <ul>
                ...
                <li>
                    <em>
                        I saw <span className="text-info">their</span> new car.
                    </em>
                </li>
                <li>
                    <em>
                        Do you think <span className="text-info">they're</span>{" "}
                        happy?
                    </em>
                </li>
            </ul>
            ...
            <p>
                <strong>
                    12. The contraction <em>he's</em> can mean <em>he is</em> OR{" "}
                    <em>he has</em>. Similarly, <em>she's</em> can mean{" "}
                    <em>she is</em> OR <em>she has</em>, and <em>it's</em> can
                    mean <em>it is</em> OR <em>it has</em>, and <em>John's</em>{" "}
            ...
            <ul>
                ...
                <li>
                    <em>
                        <span className="text-info">John has</span> divorced his
                        wife.
                    </em>
                </li>
            </ul>
            ...
            <p>
                <strong>
                    13. The contraction <em>he'd</em> can mean <em>he had</em>{" "}
                    OR <em>he would</em>. Similarly, <em>they'd</em> can mean{" "}
                    <em>they had</em> OR <em>they would</em>.
                </strong>
            </p>
            <ul>
                <li>
            ...
            <p>
                <strong>
                    14. Spell a proper noun with an initial capital letter. A{" "}
            ...
            <ul>
                ...
                <li>
                    <em>
                        Do you speak <span className="text-info">English</span>?
                    </em>
                </li>
            </ul>
            ...
            <p>
                <strong>
                    15. Spell proper adjectives with an initial capital letter.
                    Proper adjectives are made from proper nouns, for example
                    Germany → German, Orwell → Orwellian, Machiavelli →
                    Machiavellian
                </strong>
                .
            </p>
            <ul>
                <li>
                    <em>
                        London is an <span className="text-info">English</span>{" "}
                        town.
                    </em>
                </li>
                <li>
                    <em>
                        Who is the <span className="text-info">Canadian</span>{" "}
                        prime minister?
                    </em>
                </li>
                <li>
                    <em>
                        ...
                        <span className="text-info">Shakespearian</span> play?
                    </em>
                </li>
            </ul>
            ...
            <ul>
                <li>
                    <em>
                        ...
                        <span className="text-info">a balloon</span> in the sky.{" "}
                        <span className="text-info">The bird</span> was blue and{" "}
            ...
            <p>
                <strong>
                    ...
                    beginning with a consonant sound. Use the indefinite article{" "}
                    <em>an</em> with words beginning with a vowel sound.{" "}
                </strong>
                see{" "}
            ...
            <ul>
                <li>
                    ...
                    <em>
                        ...
                        uman endeavour, <span className="text-info">a F</span>
            ...
            <p>
                <strong>
                    18. Use <em>many</em> or <em>few</em> with countable nouns.
                    Use <em>much/a lot</em> or <em>little</em> for uncountable
                    nouns.
                </strong>{" "}
                see{" "}
            ...
            <ul>
                ...
                <li>
                    <em>
                        There are <span className="text-info">a few cars</span>{" "}
                        outside.
                    </em>
                </li>
                <li>
                    <em>
                        There is{" "}
                        <span className="text-info">little traffic</span> on the
                        roads.
                    </em>
                </li>
            </ul>
            ...
            <p>
                <strong>
                    ...
                    ) use an <em>apostrophe + s</em> for singular owners, and{" "}
                    <em>s + apostrophe</em> for plural owners.
                </strong>
            </p>
            <ul>
                <li>
            ...
            <p>
                <strong>
                    ...
                    preference to the{" "}
                    <a href="/grammar/passive-voice.htm">passive voice</a> (Fish
                    are eaten by cats).
                </strong>
            </p>
            <ul>
