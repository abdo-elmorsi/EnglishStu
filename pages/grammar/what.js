    ...
    return (
        <Card>
            ...
            <Card.Body>
                ...
                <div className="ec-panel-definition">
                    {" "}
                ...
                <Row>
                    <Col sm="12" lg="7">
                        <p>
                            ...
                            which evolved into words, phrases and sentences. No
                ...
                <p>
                    ...
                    Children start to speak before they even know the word
                    "grammar". But if you are serious about learning a foreign
                    language, the long answer is "yes, grammar can help you to
                    learn a language more quickly and more efficiently." It's
                    important to think of grammar as something that can help
                ...
                <p>
                    ...
                    something that you can use to find your way - like a
                    signpost or a map.
                </p>
                ...
                <p>
                    *Except invented languages like{" "}
                    ...
                    . And if Esperanto were widely spoken, its rules would soon
                    be very different.
                </p>
