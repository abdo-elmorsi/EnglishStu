...
export default function Test_yourself() {
    ...
    return (
        <>
            ...
            <Card>
                <Card.Header>
                    <h1 className="text-center">Grammar 📒</h1>
                </Card.Header>
                <Card.Body>
                    <p>
                        Grammar is the way we arrange words to make proper
                        sentences. <a href="#word">Word level grammar</a> covers
                        verbs and tenses, nouns, adverbs etc. Sentence level
                    ...
                    <Row className="mt-4">
                        <Col md={6}>
                            <p>
                                ...
                                and <strong>Verb Tenses </strong>Action verbs,
                                express what is happening <em>(do, work)</em>.
                                State verbs express a situation{" "}
                                <em>(be, have)</em>.
                            </p>
                            <p>
                                ...
                                Nouns represent people <em>(teacher, Mary)</em>,
                                places <em>(town, Asia)</em> and things{" "}
                                <em>(table, music)</em>.
                            </p>
                            <p>
                                ...
                                a noun <em>(big, red, expensive)</em>.
                            </p>
                            <p>
                                ...
                                Adverbs tell us more about verbs, adjectives or
                                adverbs (<em>loudly, really, extremely)</em>.
                            </p>
                        </Col>
                        ...
                        <Col md={6}>
                            <p>
                                ...
                                <em>the,&nbsp;an,&nbsp;this</em> that start a
                                noun phrase.
                            </p>
                            <p>
                                ...
                                A preposition expresses the relationship of a
                            ...
                            <p>
                                ...
                                Pronouns are small words like{" "}
                                <em>you, ours, some</em> that can take the place
                                of a noun.{" "}
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                Short exclamations with no real grammatical
                                value <em>(ah, dear, er)</em>
                            </p>
                        </Col>
                    </Row>
                </Card.Body>
